...
int spibus_send(uint8_t* buffer, int len); //todo add chip selection to this and send spibus_packets down the queue to load different configs for different chips
